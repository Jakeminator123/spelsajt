...
| `GET /ready` | Implementerad och driftprobad | Returnerar 200 först när Postgres svarar och committed-event-reläet lyssnar. CI terminerar den riktiga LISTEN-sessionen och verifierar 503, socketnedkoppling, ny LISTEN i samma process och återgång till 200. |
